...
//
// This example shows a simple particle system that uses the
// compute shader to calculate the evolution of the system.
//
// What is interesting is that the shader storage buffer block
// used by the compute shader for the particle positions is binded
// as an array buffer for the draw task thus streaming GL_POINTS 
// into the drawing shaders.
//
...
const OSG::Real32 world_size       =     500.0;
const OSG::UInt32 particle_count   = 6000000;
const OSG::UInt32 attractor_count  =      12;
const OSG::Real32 attractor_time   =       5.0f;
const OSG::Real32 attractor_factor =     100.0f;
...
const OSG::Real32 attractor_max = 60.0f;
