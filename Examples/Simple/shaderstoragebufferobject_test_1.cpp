...
// } example;
//
// layout(shared) buffer Examples
// {
//     Example example[3];
// } examples;
//
// For this example the values must be provided for the following data slots (second column):
//
...
OSG::ShaderStorageBufferObjChunkTransitPtr create_example_block_state()
{
    ...
    ssbo->setBlockName("Examples");
    ssbo->setUsage(GL_STREAM_DRAW);

    ssbo->addFloat   ("Examples.example[0].a");
    ssbo->addVec2    ("Examples.example[0].b");
    ssbo->addVec3    ("Examples.example[0].c");
    ssbo->addFloat   ("Examples.example[0].d.a");
    ssbo->addBVec2   ("Examples.example[0].d.b");
    ssbo->addBVec2   ("Examples.example[0].d.c[0].a");
    ssbo->addFloat   ("Examples.example[0].d.c[0].b[0].a");
    ssbo->addIVec3   ("Examples.example[0].d.c[0].b[0].b", 3);
    ssbo->addInt     ("Examples.example[0].d.c[0].b[0].c");
    ssbo->addFloat   ("Examples.example[0].d.c[0].b[1].a");
    ssbo->addIVec3   ("Examples.example[0].d.c[0].b[1].b", 3);
    ssbo->addInt     ("Examples.example[0].d.c[0].b[1].c");
    ssbo->addFloat   ("Examples.example[0].d.c[0].c");
    ssbo->addBVec2   ("Examples.example[0].d.c[1].a");
    ssbo->addFloat   ("Examples.example[0].d.c[1].b[0].a");
    ssbo->addIVec3   ("Examples.example[0].d.c[1].b[0].b", 3);
    ssbo->addInt     ("Examples.example[0].d.c[1].b[0].c");
    ssbo->addFloat   ("Examples.example[0].d.c[1].b[1].a");
    ssbo->addIVec3   ("Examples.example[0].d.c[1].b[1].b", 3);
    ssbo->addInt     ("Examples.example[0].d.c[1].b[1].c");
    ssbo->addFloat   ("Examples.example[0].d.c[1].c");
    ssbo->addFloat   ("Examples.example[0].e");
    ssbo->addFloat   ("Examples.example[0].f", 2);
    ssbo->addMat2x3  ("Examples.example[0].g");
    ssbo->addUVec3   ("Examples.example[0].h[0].a");
    ssbo->addVec2    ("Examples.example[0].h[0].b");
    ssbo->addFloat   ("Examples.example[0].h[0].c", 2);
    ssbo->addVec2    ("Examples.example[0].h[0].d");
    ssbo->addMat3    ("Examples.example[0].h[0].e", 2);
    ssbo->addUVec3   ("Examples.example[0].h[1].a");
    ssbo->addVec2    ("Examples.example[0].h[1].b");
    ssbo->addFloat   ("Examples.example[0].h[1].c", 2);
    ssbo->addVec2    ("Examples.example[0].h[1].d");
    ssbo->addMat3    ("Examples.example[0].h[1].e", 2);
#ifdef HAS_FP64_EXTENSION
    ssbo->addDouble  ("Examples.example[0].i");
#endif
    ssbo->addBool    ("Examples.example[0].j");
#ifdef HAS_FP64_EXTENSION
    ssbo->addDVec2   ("Examples.example[0].k.a");
#endif
    ssbo->addInt     ("Examples.example[0].k.b");
    ssbo->addFloat   ("Examples.example[0].k.c[0].a");
    ssbo->addIVec3   ("Examples.example[0].k.c[0].b", 3);
    ssbo->addInt     ("Examples.example[0].k.c[0].c");
    ssbo->addFloat   ("Examples.example[0].k.c[1].a");
    ssbo->addIVec3   ("Examples.example[0].k.c[1].b", 3);
    ssbo->addInt     ("Examples.example[0].k.c[1].c");
    ssbo->addFloat   ("Examples.example[0].k.c[2].a");
    ssbo->addIVec3   ("Examples.example[0].k.c[2].b", 3);
    ssbo->addInt     ("Examples.example[0].k.c[2].c");
    ssbo->addFloat   ("Examples.example[0].k.c[3].a");
    ssbo->addIVec3   ("Examples.example[0].k.c[3].b", 3);
    ssbo->addInt     ("Examples.example[0].k.c[3].c");

    ssbo->addFloat   ("Examples.example[1].a");
    ssbo->addVec2    ("Examples.example[1].b");
    ssbo->addVec3    ("Examples.example[1].c");
    ssbo->addFloat   ("Examples.example[1].d.a");
    ssbo->addBVec2   ("Examples.example[1].d.b");
    ssbo->addBVec2   ("Examples.example[1].d.c[0].a");
    ssbo->addFloat   ("Examples.example[1].d.c[0].b[0].a");
    ssbo->addIVec3   ("Examples.example[1].d.c[0].b[0].b", 3);
    ssbo->addInt     ("Examples.example[1].d.c[0].b[0].c");
    ssbo->addFloat   ("Examples.example[1].d.c[0].b[1].a");
    ssbo->addIVec3   ("Examples.example[1].d.c[0].b[1].b", 3);
    ssbo->addInt     ("Examples.example[1].d.c[0].b[1].c");
    ssbo->addFloat   ("Examples.example[1].d.c[0].c");
    ssbo->addBVec2   ("Examples.example[1].d.c[1].a");
    ssbo->addFloat   ("Examples.example[1].d.c[1].b[0].a");
    ssbo->addIVec3   ("Examples.example[1].d.c[1].b[0].b", 3);
    ssbo->addInt     ("Examples.example[1].d.c[1].b[0].c");
    ssbo->addFloat   ("Examples.example[1].d.c[1].b[1].a");
    ssbo->addIVec3   ("Examples.example[1].d.c[1].b[1].b", 3);
    ssbo->addInt     ("Examples.example[1].d.c[1].b[1].c");
    ssbo->addFloat   ("Examples.example[1].d.c[1].c");
    ssbo->addFloat   ("Examples.example[1].e");
    ssbo->addFloat   ("Examples.example[1].f", 2);
    ssbo->addMat2x3  ("Examples.example[1].g");
    ssbo->addUVec3   ("Examples.example[1].h[0].a");
    ssbo->addVec2    ("Examples.example[1].h[0].b");
    ssbo->addFloat   ("Examples.example[1].h[0].c", 2);
    ssbo->addVec2    ("Examples.example[1].h[0].d");
    ssbo->addMat3    ("Examples.example[1].h[0].e", 2);
    ssbo->addUVec3   ("Examples.example[1].h[1].a");
    ssbo->addVec2    ("Examples.example[1].h[1].b");
    ssbo->addFloat   ("Examples.example[1].h[1].c", 2);
    ssbo->addVec2    ("Examples.example[1].h[1].d");
    ssbo->addMat3    ("Examples.example[1].h[1].e", 2);
#ifdef HAS_FP64_EXTENSION
    ssbo->addDouble  ("Examples.example[1].i");
#endif
    ssbo->addBool    ("Examples.example[1].j");
#ifdef HAS_FP64_EXTENSION
    ssbo->addDVec2   ("Examples.example[1].k.a");
#endif
    ssbo->addInt     ("Examples.example[1].k.b");
    ssbo->addFloat   ("Examples.example[1].k.c[0].a");
    ssbo->addIVec3   ("Examples.example[1].k.c[0].b", 3);
    ssbo->addInt     ("Examples.example[1].k.c[0].c");
    ssbo->addFloat   ("Examples.example[1].k.c[1].a");
    ssbo->addIVec3   ("Examples.example[1].k.c[1].b", 3);
    ssbo->addInt     ("Examples.example[1].k.c[1].c");
    ssbo->addFloat   ("Examples.example[1].k.c[2].a");
    ssbo->addIVec3   ("Examples.example[1].k.c[2].b", 3);
    ssbo->addInt     ("Examples.example[1].k.c[2].c");
    ssbo->addFloat   ("Examples.example[1].k.c[3].a");
    ssbo->addIVec3   ("Examples.example[1].k.c[3].b", 3);
    ssbo->addInt     ("Examples.example[1].k.c[3].c");

    ssbo->addFloat   ("Examples.example[2].a");
    ssbo->addVec2    ("Examples.example[2].b");
    ssbo->addVec3    ("Examples.example[2].c");
    ssbo->addFloat   ("Examples.example[2].d.a");
    ssbo->addBVec2   ("Examples.example[2].d.b");
    ssbo->addBVec2   ("Examples.example[2].d.c[0].a");
    ssbo->addFloat   ("Examples.example[2].d.c[0].b[0].a");
    ssbo->addIVec3   ("Examples.example[2].d.c[0].b[0].b", 3);
    ssbo->addInt     ("Examples.example[2].d.c[0].b[0].c");
    ssbo->addFloat   ("Examples.example[2].d.c[0].b[1].a");
    ssbo->addIVec3   ("Examples.example[2].d.c[0].b[1].b", 3);
    ssbo->addInt     ("Examples.example[2].d.c[0].b[1].c");
    ssbo->addFloat   ("Examples.example[2].d.c[0].c");
    ssbo->addBVec2   ("Examples.example[2].d.c[1].a");
    ssbo->addFloat   ("Examples.example[2].d.c[1].b[0].a");
    ssbo->addIVec3   ("Examples.example[2].d.c[1].b[0].b", 3);
    ssbo->addInt     ("Examples.example[2].d.c[1].b[0].c");
    ssbo->addFloat   ("Examples.example[2].d.c[1].b[1].a");
    ssbo->addIVec3   ("Examples.example[2].d.c[1].b[1].b", 3);
    ssbo->addInt     ("Examples.example[2].d.c[1].b[1].c");
    ssbo->addFloat   ("Examples.example[2].d.c[1].c");
    ssbo->addFloat   ("Examples.example[2].e");
    ssbo->addFloat   ("Examples.example[2].f", 2);
    ssbo->addMat2x3  ("Examples.example[2].g");
    ssbo->addUVec3   ("Examples.example[2].h[0].a");
    ssbo->addVec2    ("Examples.example[2].h[0].b");
    ssbo->addFloat   ("Examples.example[2].h[0].c", 2);
    ssbo->addVec2    ("Examples.example[2].h[0].d");
    ssbo->addMat3    ("Examples.example[2].h[0].e", 2);
    ssbo->addUVec3   ("Examples.example[2].h[1].a");
    ssbo->addVec2    ("Examples.example[2].h[1].b");
    ssbo->addFloat   ("Examples.example[2].h[1].c", 2);
    ssbo->addVec2    ("Examples.example[2].h[1].d");
    ssbo->addMat3    ("Examples.example[2].h[1].e", 2);
#ifdef HAS_FP64_EXTENSION
    ssbo->addDouble  ("Examples.example[2].i");
#endif
    ssbo->addBool    ("Examples.example[2].j");
#ifdef HAS_FP64_EXTENSION
    ssbo->addDVec2   ("Examples.example[2].k.a");
#endif
    ssbo->addInt     ("Examples.example[2].k.b");
    ssbo->addFloat   ("Examples.example[2].k.c[0].a");
    ssbo->addIVec3   ("Examples.example[2].k.c[0].b", 3);
    ssbo->addInt     ("Examples.example[2].k.c[0].c");
    ssbo->addFloat   ("Examples.example[2].k.c[1].a");
    ssbo->addIVec3   ("Examples.example[2].k.c[1].b", 3);
    ssbo->addInt     ("Examples.example[2].k.c[1].c");
    ssbo->addFloat   ("Examples.example[2].k.c[2].a");
    ssbo->addIVec3   ("Examples.example[2].k.c[2].b", 3);
    ssbo->addInt     ("Examples.example[2].k.c[2].c");
    ssbo->addFloat   ("Examples.example[2].k.c[3].a");
    ssbo->addIVec3   ("Examples.example[2].k.c[3].b", 3);
    ssbo->addInt     ("Examples.example[2].k.c[3].c");
...
{
    ssbo->setFloat   ("Examples.example[0].a", 1234.56f);
    ssbo->setVec2    ("Examples.example[0].b", OSG::Vec2f(1.4f, 8.6f));
    ssbo->setVec3    ("Examples.example[0].c", OSG::Vec3f(0.1f, 0.2f, 0.3f));
    ssbo->setFloat   ("Examples.example[0].d.a", 8123.45f);
    ssbo->setBVec2   ("Examples.example[0].d.b", OSG::Vec2b(true, false));
    ssbo->setBVec2   ("Examples.example[0].d.c[0].a", OSG::Vec2b(true, true));
    ssbo->setFloat   ("Examples.example[0].d.c[0].b[0].a", 7812.34f);
    ssbo->setIVec3   ("Examples.example[0].d.c[0].b[0].b", OSG::Vec3i(0,-1,2), 0);
    ssbo->setIVec3   ("Examples.example[0].d.c[0].b[0].b", OSG::Vec3i(1,-2,3), 1);
    ssbo->setIVec3   ("Examples.example[0].d.c[0].b[0].b", OSG::Vec3i(4,-5,6), 2);
    ssbo->setInt     ("Examples.example[0].d.c[0].b[0].c", 6781);
    ssbo->setFloat   ("Examples.example[0].d.c[0].b[1].a", 5678.12f);
    ssbo->setIVec3   ("Examples.example[0].d.c[0].b[1].b", OSG::Vec3i(-7,8,9),    0);
    ssbo->setIVec3   ("Examples.example[0].d.c[0].b[1].b", OSG::Vec3i(-10,11,12), 1);
    ssbo->setIVec3   ("Examples.example[0].d.c[0].b[1].b", OSG::Vec3i(-13,14,15), 2);
    ssbo->setInt     ("Examples.example[0].d.c[0].b[1].c", 4567);
    ssbo->setFloat   ("Examples.example[0].d.c[0].c", 3456.78f);
    ssbo->setBVec2   ("Examples.example[0].d.c[1].a", OSG::Vec2b(false, true));
    ssbo->setFloat   ("Examples.example[0].d.c[1].b[0].a", 2345.67f);
    ssbo->setIVec3   ("Examples.example[0].d.c[1].b[0].b", OSG::Vec3i(16,17,-18), 0);
    ssbo->setIVec3   ("Examples.example[0].d.c[1].b[0].b", OSG::Vec3i(19,20,-21), 1);
    ssbo->setIVec3   ("Examples.example[0].d.c[1].b[0].b", OSG::Vec3i(22,23,-24), 2);
    ssbo->setInt     ("Examples.example[0].d.c[1].b[0].c", 123);
    ssbo->setFloat   ("Examples.example[0].d.c[1].b[1].a", 812.34f);
    ssbo->setIVec3   ("Examples.example[0].d.c[1].b[1].b", OSG::Vec3i(25,-26,27), 0);
    ssbo->setIVec3   ("Examples.example[0].d.c[1].b[1].b", OSG::Vec3i(28,-29,30), 1);
    ssbo->setIVec3   ("Examples.example[0].d.c[1].b[1].b", OSG::Vec3i(31,-32,33), 2);
    ssbo->setInt     ("Examples.example[0].d.c[1].b[1].c", 781);
    ssbo->setFloat   ("Examples.example[0].d.c[1].c", 678.12f);
    ssbo->setFloat   ("Examples.example[0].e", 567.81f);
    ssbo->setFloat   ("Examples.example[0].f", 456.78f, 0);
    ssbo->setFloat   ("Examples.example[0].f", 345.67f, 1);
    ...
    ssbo->setMat2x3  ("Examples.example[0].g", mat01);
    ssbo->setUVec3   ("Examples.example[0].h[0].a", OSG::Vec3u(91,82,73));
    ssbo->setVec2    ("Examples.example[0].h[0].b", OSG::Vec2f(2.5f, 9.7f));
    ssbo->setFloat   ("Examples.example[0].h[0].c", 234.56f, 0);
    ssbo->setFloat   ("Examples.example[0].h[0].c", 12.34f, 1);
    ssbo->setVec2    ("Examples.example[0].h[0].d", OSG::Vec2f(3.6f, 1.3f));
    ...
    ssbo->setMat3    ("Examples.example[0].h[0].e", mat02, 0);
    ssbo->setMat3    ("Examples.example[0].h[0].e", mat03, 1);
    ssbo->setUVec3   ("Examples.example[0].h[1].a", OSG::Vec3u(71,82,93));
    ssbo->setVec2    ("Examples.example[0].h[1].b", OSG::Vec2f(4.5f, 2.4f));
    ssbo->setFloat   ("Examples.example[0].h[1].c", 81.23f, 0);
    ssbo->setFloat   ("Examples.example[0].h[1].c", 78.12f, 1);
    ssbo->setVec2    ("Examples.example[0].h[1].d", OSG::Vec2f(5.7f, 3.5f));
    ...
    ssbo->setMat3    ("Examples.example[0].h[1].e", mat04, 0);
    ssbo->setMat3    ("Examples.example[0].h[1].e", mat05, 1);
#ifdef HAS_FP64_EXTENSION
    ssbo->setDouble  ("Examples.example[0].i", 94.345678);
#endif
    ssbo->setBool    ("Examples.example[0].j", true);
#ifdef HAS_FP64_EXTENSION
    ssbo->setDVec2   ("Examples.example[0].k.a", OSG::Vec2d(12.874, -2346.985633));
#endif
    ssbo->setInt     ("Examples.example[0].k.b", 3);
    ssbo->setFloat   ("Examples.example[0].k.c[0].a", 67.81f);
    ssbo->setIVec3   ("Examples.example[0].k.c[0].b", OSG::Vec3i(34,35,-36), 0);
    ssbo->setIVec3   ("Examples.example[0].k.c[0].b", OSG::Vec3i(37,38,-39), 1);
    ssbo->setIVec3   ("Examples.example[0].k.c[0].b", OSG::Vec3i(40,41,-42), 2);
    ssbo->setInt     ("Examples.example[0].k.c[0].c", -4);
    ssbo->setFloat   ("Examples.example[0].k.c[1].a", 56.78f);
    ssbo->setIVec3   ("Examples.example[0].k.c[1].b", OSG::Vec3i(-43,44,45), 0);
    ssbo->setIVec3   ("Examples.example[0].k.c[1].b", OSG::Vec3i(-46,47,48), 1);
    ssbo->setIVec3   ("Examples.example[0].k.c[1].b", OSG::Vec3i(-49,50,51), 2);
    ssbo->setInt     ("Examples.example[0].k.c[1].c", -5);
    ssbo->setFloat   ("Examples.example[0].k.c[2].a", 45.67f);
    ssbo->setIVec3   ("Examples.example[0].k.c[2].b", OSG::Vec3i(52,-53,54), 0);
    ssbo->setIVec3   ("Examples.example[0].k.c[2].b", OSG::Vec3i(55,-56,57), 1);
    ssbo->setIVec3   ("Examples.example[0].k.c[2].b", OSG::Vec3i(58,-59,60), 2);
    ssbo->setInt     ("Examples.example[0].k.c[2].c", -6);
    ssbo->setFloat   ("Examples.example[0].k.c[3].a", 34.56f);
    ssbo->setIVec3   ("Examples.example[0].k.c[3].b", OSG::Vec3i(61,62,-63), 0);
    ssbo->setIVec3   ("Examples.example[0].k.c[3].b", OSG::Vec3i(64,-65,66), 1);
    ssbo->setIVec3   ("Examples.example[0].k.c[3].b", OSG::Vec3i(-67,68,69), 2);
    ssbo->setInt     ("Examples.example[0].k.c[3].c", 7);



    ssbo->setFloat   ("Examples.example[1].a", 91234.56f);
    ssbo->setVec2    ("Examples.example[1].b", OSG::Vec2f(91.4f, 98.6f));
    ssbo->setVec3    ("Examples.example[1].c", OSG::Vec3f(90.1f, 90.2f, 90.3f));
    ssbo->setFloat   ("Examples.example[1].d.a", 98123.45f);
    ssbo->setBVec2   ("Examples.example[1].d.b", OSG::Vec2b(false, false));
    ssbo->setBVec2   ("Examples.example[1].d.c[0].a", OSG::Vec2b(true, false));
    ssbo->setFloat   ("Examples.example[1].d.c[0].b[0].a", 97812.34f);
    ssbo->setIVec3   ("Examples.example[1].d.c[0].b[0].b", OSG::Vec3i(90,-91,92), 0);
    ssbo->setIVec3   ("Examples.example[1].d.c[0].b[0].b", OSG::Vec3i(91,-92,93), 1);
    ssbo->setIVec3   ("Examples.example[1].d.c[0].b[0].b", OSG::Vec3i(94,-95,96), 2);
    ssbo->setInt     ("Examples.example[1].d.c[0].b[0].c", 6781);
    ssbo->setFloat   ("Examples.example[1].d.c[0].b[1].a", 5678.12f);
    ssbo->setIVec3   ("Examples.example[1].d.c[0].b[1].b", OSG::Vec3i(-97,98,99),    0);
    ssbo->setIVec3   ("Examples.example[1].d.c[0].b[1].b", OSG::Vec3i(-910,911,912), 1);
    ssbo->setIVec3   ("Examples.example[1].d.c[0].b[1].b", OSG::Vec3i(-913,914,915), 2);
    ssbo->setInt     ("Examples.example[1].d.c[0].b[1].c", 94567);
    ssbo->setFloat   ("Examples.example[1].d.c[0].c", 93456.78f);
    ssbo->setBVec2   ("Examples.example[1].d.c[1].a", OSG::Vec2b(false, true));
    ssbo->setFloat   ("Examples.example[1].d.c[1].b[0].a", 92345.67f);
    ssbo->setIVec3   ("Examples.example[1].d.c[1].b[0].b", OSG::Vec3i(916,917,-918), 0);
    ssbo->setIVec3   ("Examples.example[1].d.c[1].b[0].b", OSG::Vec3i(919,920,-921), 1);
    ssbo->setIVec3   ("Examples.example[1].d.c[1].b[0].b", OSG::Vec3i(922,923,-924), 2);
    ssbo->setInt     ("Examples.example[1].d.c[1].b[0].c", 9123);
    ssbo->setFloat   ("Examples.example[1].d.c[1].b[1].a", 9812.34f);
    ssbo->setIVec3   ("Examples.example[1].d.c[1].b[1].b", OSG::Vec3i(925,-926,927), 0);
    ssbo->setIVec3   ("Examples.example[1].d.c[1].b[1].b", OSG::Vec3i(928,-929,930), 1);
    ssbo->setIVec3   ("Examples.example[1].d.c[1].b[1].b", OSG::Vec3i(931,-932,933), 2);
    ssbo->setInt     ("Examples.example[1].d.c[1].b[1].c", 9781);
    ssbo->setFloat   ("Examples.example[1].d.c[1].c", 9678.12f);
    ssbo->setFloat   ("Examples.example[1].e", 9567.81f);
    ssbo->setFloat   ("Examples.example[1].f", 9456.78f, 0);
    ssbo->setFloat   ("Examples.example[1].f", 9345.67f, 1);
    ...
    ssbo->setMat2x3  ("Examples.example[1].g", mat11);
    ssbo->setUVec3   ("Examples.example[1].h[0].a", OSG::Vec3u(991,982,973));
    ssbo->setVec2    ("Examples.example[1].h[0].b", OSG::Vec2f(92.5f, 99.7f));
    ssbo->setFloat   ("Examples.example[1].h[0].c", 9234.56f, 0);
    ssbo->setFloat   ("Examples.example[1].h[0].c", 912.34f,  1);
    ssbo->setVec2    ("Examples.example[1].h[0].d", OSG::Vec2f(93.6f, 91.3f));
    ...
    ssbo->setMat3    ("Examples.example[1].h[0].e", mat12, 0);
    ssbo->setMat3    ("Examples.example[1].h[0].e", mat13, 1);
    ssbo->setUVec3   ("Examples.example[1].h[1].a", OSG::Vec3u(971,982,93));
    ssbo->setVec2    ("Examples.example[1].h[1].b", OSG::Vec2f(94.5f, 92.4f));
    ssbo->setFloat   ("Examples.example[1].h[1].c", 981.23f, 0);
    ssbo->setFloat   ("Examples.example[1].h[1].c", 978.12f, 1);
    ssbo->setVec2    ("Examples.example[1].h[1].d", OSG::Vec2f(95.7f, 93.5f));
    ...
    ssbo->setMat3    ("Examples.example[1].h[1].e", mat14, 0);
    ssbo->setMat3    ("Examples.example[1].h[1].e", mat15, 1);
#ifdef HAS_FP64_EXTENSION
    ssbo->setDouble  ("Examples.example[1].i", 994.345678);
#endif
    ssbo->setBool    ("Examples.example[1].j", false);
#ifdef HAS_FP64_EXTENSION
    ssbo->setDVec2   ("Examples.example[1].k.a", OSG::Vec2d(912.874, -92346.985633));
#endif
    ssbo->setInt     ("Examples.example[1].k.b", 93);
    ssbo->setFloat   ("Examples.example[1].k.c[0].a", 967.81f);
    ssbo->setIVec3   ("Examples.example[1].k.c[0].b", OSG::Vec3i(934,935,-936), 0);
    ssbo->setIVec3   ("Examples.example[1].k.c[0].b", OSG::Vec3i(937,938,-939), 1);
    ssbo->setIVec3   ("Examples.example[1].k.c[0].b", OSG::Vec3i(940,941,-942), 2);
    ssbo->setInt     ("Examples.example[1].k.c[0].c", -94);
    ssbo->setFloat   ("Examples.example[1].k.c[1].a", 956.78f);
    ssbo->setIVec3   ("Examples.example[1].k.c[1].b", OSG::Vec3i(-943,944,945), 0);
    ssbo->setIVec3   ("Examples.example[1].k.c[1].b", OSG::Vec3i(-946,947,948), 1);
    ssbo->setIVec3   ("Examples.example[1].k.c[1].b", OSG::Vec3i(-949,950,951), 2);
    ssbo->setInt     ("Examples.example[1].k.c[1].c", -95);
    ssbo->setFloat   ("Examples.example[1].k.c[2].a", 945.67f);
    ssbo->setIVec3   ("Examples.example[1].k.c[2].b", OSG::Vec3i(952,-953,954), 0);
    ssbo->setIVec3   ("Examples.example[1].k.c[2].b", OSG::Vec3i(955,-956,957), 1);
    ssbo->setIVec3   ("Examples.example[1].k.c[2].b", OSG::Vec3i(958,-959,960), 2);
    ssbo->setInt     ("Examples.example[1].k.c[2].c", -96);
    ssbo->setFloat   ("Examples.example[1].k.c[3].a", 934.56f);
    ssbo->setIVec3   ("Examples.example[1].k.c[3].b", OSG::Vec3i(961,962,-963), 0);
    ssbo->setIVec3   ("Examples.example[1].k.c[3].b", OSG::Vec3i(964,-965,966), 1);
    ssbo->setIVec3   ("Examples.example[1].k.c[3].b", OSG::Vec3i(-967,968,969), 2);
    ssbo->setInt     ("Examples.example[1].k.c[3].c", 97);



    ssbo->setFloat   ("Examples.example[2].a", 71234.56f);
    ssbo->setVec2    ("Examples.example[2].b", OSG::Vec2f(71.4f, 78.6f));
    ssbo->setVec3    ("Examples.example[2].c", OSG::Vec3f(70.1f, 70.2f, 70.3f));
    ssbo->setFloat   ("Examples.example[2].d.a", 78123.45f);
    ssbo->setBVec2   ("Examples.example[2].d.b", OSG::Vec2b(true, true));
    ssbo->setBVec2   ("Examples.example[2].d.c[0].a", OSG::Vec2b(true, false));
    ssbo->setFloat   ("Examples.example[2].d.c[0].b[0].a", 77812.34f);
    ssbo->setIVec3   ("Examples.example[2].d.c[0].b[0].b", OSG::Vec3i(70,-71,72), 0);
    ssbo->setIVec3   ("Examples.example[2].d.c[0].b[0].b", OSG::Vec3i(71,-72,73), 1);
    ssbo->setIVec3   ("Examples.example[2].d.c[0].b[0].b", OSG::Vec3i(74,-75,76), 2);
    ssbo->setInt     ("Examples.example[2].d.c[0].b[0].c", 76781);
    ssbo->setFloat   ("Examples.example[2].d.c[0].b[1].a", 75678.12f);
    ssbo->setIVec3   ("Examples.example[2].d.c[0].b[1].b", OSG::Vec3i(-77,78,79),    0);
    ssbo->setIVec3   ("Examples.example[2].d.c[0].b[1].b", OSG::Vec3i(-710,711,712), 1);
    ssbo->setIVec3   ("Examples.example[2].d.c[0].b[1].b", OSG::Vec3i(-713,714,715), 2);
    ssbo->setInt     ("Examples.example[2].d.c[0].b[1].c", 74567);
    ssbo->setFloat   ("Examples.example[2].d.c[0].c", 73456.78f);
    ssbo->setBVec2   ("Examples.example[2].d.c[1].a",OSG::Vec2b(true, true));
    ssbo->setFloat   ("Examples.example[2].d.c[1].b[0].a", 72345.67f);
    ssbo->setIVec3   ("Examples.example[2].d.c[1].b[0].b", OSG::Vec3i(716,717,-718), 0);
    ssbo->setIVec3   ("Examples.example[2].d.c[1].b[0].b", OSG::Vec3i(719,720,-721), 1);
    ssbo->setIVec3   ("Examples.example[2].d.c[1].b[0].b", OSG::Vec3i(722,723,-724), 2);
    ssbo->setInt     ("Examples.example[2].d.c[1].b[0].c", 7123);
    ssbo->setFloat   ("Examples.example[2].d.c[1].b[1].a", 7812.34f);
    ssbo->setIVec3   ("Examples.example[2].d.c[1].b[1].b", OSG::Vec3i(725,-726,727), 0);
    ssbo->setIVec3   ("Examples.example[2].d.c[1].b[1].b", OSG::Vec3i(728,-729,730), 1);
    ssbo->setIVec3   ("Examples.example[2].d.c[1].b[1].b", OSG::Vec3i(731,-732,733), 2);
    ssbo->setInt     ("Examples.example[2].d.c[1].b[1].c", 7781);
    ssbo->setFloat   ("Examples.example[2].d.c[1].c", 7678.12f);
    ssbo->setFloat   ("Examples.example[2].e", 7567.81f);
    ssbo->setFloat   ("Examples.example[2].f", 7456.78f, 0);
    ssbo->setFloat   ("Examples.example[2].f", 7345.67f, 1);
    ...
    ssbo->setMat2x3  ("Examples.example[2].g", mat21);
    ssbo->setUVec3   ("Examples.example[2].h[0].a", OSG::Vec3u(791,782,73));
    ssbo->setVec2    ("Examples.example[2].h[0].b", OSG::Vec2f(72.5f, 79.7f));
    ssbo->setFloat   ("Examples.example[2].h[0].c", 7234.56f, 0);
    ssbo->setFloat   ("Examples.example[2].h[0].c", 712.34f,  1);
    ssbo->setVec2    ("Examples.example[2].h[0].d", OSG::Vec2f(73.6f, 71.3f));
    ...
    ssbo->setMat3    ("Examples.example[2].h[0].e", mat22, 0);
    ssbo->setMat3    ("Examples.example[2].h[0].e", mat23, 1);
    ssbo->setUVec3   ("Examples.example[2].h[1].a", OSG::Vec3u(771,782,793));
    ssbo->setVec2    ("Examples.example[2].h[1].b", OSG::Vec2f(74.5f, 72.4f));
    ssbo->setFloat   ("Examples.example[2].h[1].c", 781.23f, 0);
    ssbo->setFloat   ("Examples.example[2].h[1].c", 778.12f, 1);
    ssbo->setVec2    ("Examples.example[2].h[1].d", OSG::Vec2f(75.7f, 73.5f));
    ...
    ssbo->setMat3    ("Examples.example[2].h[1].e", mat24, 0);
    ssbo->setMat3    ("Examples.example[2].h[1].e", mat25, 1);
#ifdef HAS_FP64_EXTENSION
    ssbo->setDouble  ("Examples.example[2].i", 794.345678);
#endif
    ssbo->setBool    ("Examples.example[2].j", true);
#ifdef HAS_FP64_EXTENSION
    ssbo->setDVec2   ("Examples.example[2].k.a", OSG::Vec2d(712.874, -72346.985633));
#endif
    ssbo->setInt     ("Examples.example[2].k.b", 73);
    ssbo->setFloat   ("Examples.example[2].k.c[0].a", 767.81f);
    ssbo->setIVec3   ("Examples.example[2].k.c[0].b", OSG::Vec3i(734,735,-736), 0);
    ssbo->setIVec3   ("Examples.example[2].k.c[0].b", OSG::Vec3i(737,738,-739), 1);
    ssbo->setIVec3   ("Examples.example[2].k.c[0].b", OSG::Vec3i(740,741,-742), 2);
    ssbo->setInt     ("Examples.example[2].k.c[0].c", -74);
    ssbo->setFloat   ("Examples.example[2].k.c[1].a", 756.78f);
    ssbo->setIVec3   ("Examples.example[2].k.c[1].b", OSG::Vec3i(-743,744,745), 0);
    ssbo->setIVec3   ("Examples.example[2].k.c[1].b", OSG::Vec3i(-746,747,748), 1);
    ssbo->setIVec3   ("Examples.example[2].k.c[1].b", OSG::Vec3i(-749,750,751), 2);
    ssbo->setInt     ("Examples.example[2].k.c[1].c", -75);
    ssbo->setFloat   ("Examples.example[2].k.c[2].a", 745.67f);
    ssbo->setIVec3   ("Examples.example[2].k.c[2].b", OSG::Vec3i(752,-753,754), 0);
    ssbo->setIVec3   ("Examples.example[2].k.c[2].b", OSG::Vec3i(755,-756,757), 1);
    ssbo->setIVec3   ("Examples.example[2].k.c[2].b", OSG::Vec3i(758,-759,760), 2);
    ssbo->setInt     ("Examples.example[2].k.c[2].c", -76);
    ssbo->setFloat   ("Examples.example[2].k.c[3].a", 734.56f);
    ssbo->setIVec3   ("Examples.example[2].k.c[3].b", OSG::Vec3i(761,762,-763), 0);
    ssbo->setIVec3   ("Examples.example[2].k.c[3].b", OSG::Vec3i(764,-765,766), 1);
    ssbo->setIVec3   ("Examples.example[2].k.c[3].b", OSG::Vec3i(-767,768,769), 2);
    ssbo->setInt     ("Examples.example[2].k.c[3].c", 7);
}
...
int main(int argc, char **argv)
{
    ...
    // Otherwise OpenSG will complain about objects being alive after shutdown.
    {
        ...
        //
        fragShader->addShaderStorageBlock("Examples", 1); // block binding point

        prog_chunk->addShader(vertShader);
        prog_chunk->addShader(fragShader);

        //
        // create shader storage buffer object for block 'Examples'
        //
