// OpenSG Test Example: MultiPropertyUBOChunk test
//
// This example test the MultiPropertyUBOChunk
//
...
//
// The example uses the following uniform buffer block named 'ExampleBlock' 
...
//
// Create a OpenSG MultiPropertyUBOChunk object which does
...
OSG::MultiPropertyUBOChunkTransitPtr create_example_block_state()
{
    OSG::MultiPropertyUBOChunkRefPtr mpChunk = OSG::MultiPropertyUBOChunk::create();

    OSG::UInt32 float_id, double_id,  int_id, uint_id, bool_id, vec3_id, vec4_id, mat4_id;

      float_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::  FLOAT_T, 1);  f1_id =  float_id;
       vec3_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   VEC3_T, 2); v31_id =   vec3_id++; v32_id = vec3_id;
      float_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::  FLOAT_T, 1);  f2_id =  float_id;
        int_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::    INT_T, 2);  i1_id =    int_id++;  i2_id =  int_id;
       vec3_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   VEC3_T, 1); v33_id =   vec3_id;
       mat4_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   MAT4_T, 1); m41_id =   mat4_id;
       uint_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   UINT_T, 1);  u1_id =   uint_id;
       bool_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   BOOL_T, 1);  b1_id =   bool_id;
       vec4_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   VEC4_T, 1); v41_id =   vec4_id;
       mat4_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::   MAT4_T, 1); m42_id =   mat4_id;
#ifdef HAS_FP64_EXTENSION
     double_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk:: DOUBLE_T, 1);  d1_id = double_id;
#endif
      float_id = mpChunk->addMember(OSG::MultiPropertyUBOChunk::  FLOAT_T, 1);  f3_id =  float_id;
    ...
    return OSG::MultiPropertyUBOChunkTransitPtr(mpChunk);
}
...
int main(int argc, char **argv)
{
    ...
    // Otherwise OpenSG will complain about objects being alive after shutdown.
    {
        ...
        //
        OSG::MultiPropertyUBOChunkRefPtr ubo_example_block = create_example_block_state();
...
std::string get_fp_program()
{
    ...
    << endl << "} example;"
    << endl << ""
    << endl << "layout (std140) uniform ExampleBlock"
    << endl << "{"
