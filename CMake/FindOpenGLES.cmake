...
ELSE (WIN32)
  ...
  IF (APPLE)
    ...
    FIND_LIBRARY(OPENGL_gl_LIBRARY OpenGLES DOC "OpenGL lib for OSX")
    FIND_LIBRARY(OPENGL_glu_LIBRARY EAGL DOC "AGL lib for OSX")
    FIND_PATH(OPENGL_INCLUDE_DIR ES2/gl.h DOC "Include for OpenGL on OSX")
