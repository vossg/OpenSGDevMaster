...
FUNCTION(OSG_STORE_PROJECT_DEPENDENCIES)
    IF(NOT ${OSG_CMAKE_PASS} STREQUAL "OSGPASS_COLLECT")
        RETURN()
    ENDIF(NOT ${OSG_CMAKE_PASS} STREQUAL "OSGPASS_COLLECT")
...
#############################################################################
# perform default actions for pass OSGPASS_BUILD

FUNCTION(OSG_SETUP_LIBRARY_BUILD PROJ_DEFINE)

    IF(NOT ${OSG_CMAKE_PASS} STREQUAL "OSGPASS_BUILD")
        RETURN()
...
#############################################################################
# setup build of test*.cpp test programs
...
#############################################################################
# setup build of OSG*Test.cpp unittests
