...
#include "OSGQuaternionFields.h" // KeyValue type
#include "OSGQuaternionFields.h" // Value type
...
class OSG_CONTRIBCSM_DLLMAPPING OrientationInterpolatorBase : public NodeCore
{
  public:
