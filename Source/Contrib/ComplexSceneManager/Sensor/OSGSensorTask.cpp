...
// OSGSensorTaskBase.cpp file.
// To modify it, please change the .fcd file (OSGSensorTask.fcd) and
...
void SensorTask::initMethod(InitPhase ePhase)
{
...
SensorTask::SensorTask(void) :
    Inherited()
{
}

SensorTask::SensorTask(const SensorTask &source) :
    Inherited(source)
{
}
...
void SensorTask::changed(ConstFieldMaskArg whichField, 
                            UInt32            origin,
                            BitVector         details)
{
