...
#ifndef _OSGLINUXEVENTOPTIONSBASE_H_
#define _OSGLINUXEVENTOPTIONSBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief LinuxEventOptions Base Class.

class OSG_CONTRIBCSM_DLLMAPPING LinuxEventOptionsBase : public InterfaceOptions
{
  public:

    typedef InterfaceOptions Inherited;
    typedef InterfaceOptions ParentContainer;

    typedef Inherited::TypeObject TypeObject;
    typedef TypeObject::InitPhase InitPhase;

    OSG_GEN_INTERNALPTR(LinuxEventOptions);
  ...
  public:
    ...
    static const OSG::BitVector DeviceFieldMask =
        (TypeTraits<BitVector>::One << DeviceFieldId);
    static const OSG::BitVector TRangeFieldMask =
    ...
    /*! \{                                                                 */
                  ...
                  SFString            *editSFDevice         (void);
            const SFString            *getSFDevice          (void) const;

                  SFVec3f             *editSFTRange         (void);
            const SFVec3f             *getSFTRange          (void) const;
            ...
            const std::string         &getDevice          (void) const;
                  ...
                  Vec3f               &editTRange         (void);
            const Vec3f               &getTRange          (void) const;
    ...
    static  LinuxEventOptionsTransitPtr  create          (void);
    static  LinuxEventOptions           *createEmpty     (void);

    static  LinuxEventOptionsTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  LinuxEventOptions            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  LinuxEventOptionsTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    LinuxEventOptionsBase(void);
    LinuxEventOptionsBase(const LinuxEventOptionsBase &source);
    ...
    virtual ~LinuxEventOptionsBase(void);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      LinuxEventOptionsBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const LinuxEventOptionsBase &source);
};

typedef LinuxEventOptionsBase *LinuxEventOptionsBaseP;

OSG_END_NAMESPACE

#endif /* _OSGLINUXEVENTOPTIONSBASE_H_ */
