...
MACRO(OSG_CONFIGURE_NVSDKCOMMON)
    ...
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include/nvsdk/nvShaderUtils.h)
            SET(OSG_NVSDKCOMMON_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include/nvsdk CACHE PATH "" FORCE)
        ENDIF()
		...
		IF(UNIX)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_NSCB_LIBNAME}.a)
            SET(OSG_NVSDKCOMMON_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_NSCB_LIBNAME}.a)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_NSCB_LIBNAME}.a)
            SET(OSG_NVSDKCOMMON_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_NSCB_LIBNAME}.a)
          ENDIF()
        ...
        ELSEIF(WIN32)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NSCB_LIBNAME}.lib)
              SET(OSG_NVSDKCOMMON_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NSCB_LIBNAME}.lib)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NSCB_LIBNAME}D.lib)
              SET(OSG_NVSDKCOMMON_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NSCB_LIBNAME}D.lib)
          ENDIF()
...
MACRO(OSG_CONFIGURE_NVOCLUTILS)
    ...
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include/nvocl/oclUtils.h)
            SET(OSG_NVOCLUTILS_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include/nvsdk CACHE PATH "" FORCE)
        ENDIF()
		...
		IF(UNIX)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_NOUB_LIBNAME}.a)
            SET(OSG_NVOCLUTILS_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_NOUB_LIBNAME}.a)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_NOUB_LIBNAME}.a)
            SET(OSG_NVOCLUTILS_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_NOUB_LIBNAME}.a)
          ENDIF()
        ...
        ELSEIF(WIN32)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NOUB_LIBNAME}.lib)
              SET(OSG_NVOCLUTILS_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NOUB_LIBNAME}.lib)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NOUB_LIBNAME}D.lib)
              SET(OSG_NVOCLUTILS_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_NOUB_LIBNAME}D.lib)
          ENDIF()
...
MACRO(OSG_CONFIGURE_CUDACOMMON)
    ...
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include/cuda/param.h)
            SET(OSG_CUDACOMMON_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include/cuda CACHE PATH "" FORCE)
        ENDIF()
		...
		IF(UNIX)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CCB_LIBNAME}.a)
            SET(OSG_CUDACOMMON_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CCB_LIBNAME}.a)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CCB_LIBNAME}.a)
            SET(OSG_CUDACOMMON_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CCB_LIBNAME}.a)
          ENDIF()
        ...
        ELSEIF(WIN32)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.lib)
              SET(OSG_CUDACOMMON_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.lib)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}D.lib)
              SET(OSG_CUDACOMMON_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}D.lib)
          ENDIF()
...
MACRO(OSG_CONFIGURE_CUDAUTIL)
    ...
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include/cuda/cutil.h)
            SET(OSG_CUDAUTIL_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include/cuda CACHE PATH "" FORCE)
        ENDIF()
		...
		IF(UNIX)
          ...
          IF(OSG_USE_STATIC_SUPPORT_LIBS)
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUB_LIBNAME}.a)
                  SET(OSG_CUDAUTIL_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUB_LIBNAME}.a)
              ENDIF()
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUB_LIBNAME}.a)
                  SET(OSG_CUDAUTIL_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUB_LIBNAME}.a)
              ENDIF()
          ELSE()
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUB_LIBNAME}.so)
                  SET(OSG_CUDAUTIL_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUB_LIBNAME}.so)
              ENDIF()
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUB_LIBNAME}.so)
                  SET(OSG_CUDAUTIL_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUB_LIBNAME}.so)
              ENDIF()
          ENDIF()
        ELSEIF(WIN32)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUB_LIBNAME}.lib)
              SET(OSG_CUDAUTIL_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUB_LIBNAME}.lib)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUB_LIBNAME}D.lib)
              SET(OSG_CUDAUTIL_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUB_LIBNAME}D.lib)
          ENDIF()
		ENDIF()
...
MACRO(OSG_CONFIGURE_CUDPP)
    ...
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include/cuda/cudpp/cudpp.h)
            SET(OSG_CUDPP_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include/cuda CACHE PATH "" FORCE)
        ENDIF()
		...
		IF(UNIX)
          IF(OSG_USE_STATIC_SUPPORT_LIBS)
              ...
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUP_LIBNAME}.a)
                  SET(OSG_CUDPP_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUP_LIBNAME}.a)
              ENDIF()
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUP_LIBNAME}.a)
                  SET(OSG_CUDPP_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUP_LIBNAME}.a)
              ENDIF()
          ELSE()
              IF(CUDA_BUILD_EMULATION)
              ...
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUP_LIBNAME}.so)
                  SET(OSG_CUDPP_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CUP_LIBNAME}.so)
              ENDIF()
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUP_LIBNAME}.so)
                  SET(OSG_CUDPP_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CUP_LIBNAME}.so)
              ENDIF()
          ENDIF()
        ELSEIF(WIN32)
          ...
          IF(OSG_USE_STATIC_SUPPORT_LIBS)
              ...
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUP_LIBNAME}.lib)
                  SET(OSG_CUDPP_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUP_LIBNAME}.lib)
              ENDIF()
              IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUP_LIBNAME}D.lib)
                  SET(OSG_CUDPP_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CUP_LIBNAME}D.lib)
              ENDIF()
          ELSE()
...
MACRO(OSG_CONFIGURE_CUDAPARTSDK)
    ...
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include/cuda/cudapartsdk/shaders.h)
            SET(OSG_CUDAPARTSDK_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include/cuda/cudapartsdk CACHE PATH "" FORCE)
        ENDIF()
		...
		IF(UNIX)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CCB_LIBNAME}.a)
            SET(OSG_CUDAPARTSDK_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/opt/${_OSG_CCB_LIBNAME}.a)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CCB_LIBNAME}.a)
            SET(OSG_CUDAPARTSDK_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CCB_LIBNAME}.a)
          ENDIF()
        ...
        ELSEIF(WIN32)
          ...
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.lib)
              SET(OSG_CUDAPARTSDK_LIBRARY_RELEASE ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.lib)
          ENDIF()
          IF(EXISTS ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}D.lib)
              SET(OSG_CUDAPARTSDK_LIBRARY_DEBUG ${OSG_SUPPORT_ROOT}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}D.lib)
          ENDIF()
