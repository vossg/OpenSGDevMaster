...
inline
OSG::FieldContainerType &AlgorithmComputeElementBase::getClassType(void)
{
    return _type;
}
...
inline
OSG::UInt32 AlgorithmComputeElementBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 AlgorithmComputeElementBase::getClassGroupId(void)
{
...
inline
void AlgorithmComputeElementBase::execSync (      AlgorithmComputeElementBase *pFrom,
...
inline
const Char8 *AlgorithmComputeElementBase::getClassname(void)
{
    return "AlgorithmComputeElement";
}
