...
MACRO(OSG_CONFIGURE_NVSDKCOMMON)
  ...
  IF(NOT OSG_BUILD_DEPENDEND)
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include${OSG_SUPPORT_INC_SUBDIR}/nvsdk/shrQATest.h)
...
MACRO(OSG_CONFIGURE_CUDACOMMON)
  ...
  IF(NOT OSG_BUILD_DEPENDEND)
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include${OSG_SUPPORT_INC_SUBDIR}/cuda/param.h)
...
MACRO(OSG_CONFIGURE_CUDPP)
  ...
  IF(NOT OSG_BUILD_DEPENDEND)
    IF(OSG_USE_OSGSUPPORT_LIBS)
        ...
        IF(EXISTS ${OSG_SUPPORT_ROOT}/include${OSG_SUPPORT_INC_SUBDIR}/cuda/cudpp/cudpp.h)
            OSG_SET(OSG_CUDPP_INCLUDE_DIR ${OSG_SUPPORT_ROOT}/include${OSG_SUPPORT_INC_SUBDIR}/cuda CACHE PATH "" FORCE)
        ENDIF()
