...
MACRO(OSG_CONFIGURE_CUDAPARTSDK _SUPPORT_DIR)

  IF(NOT OSG_BUILD_DEPENDEND)
    IF(OSG_USE_OSGSUPPORT_LIBS)

        IF(EXISTS ${_SUPPORT_DIR}/include${OSG_SUPPORT_INC_SUBDIR}/cuda/cudapartsdk/shaders.h)
            OSG_SET(OSG_CUDAPARTSDK_INCLUDE_DIR ${_SUPPORT_DIR}/include${OSG_SUPPORT_INC_SUBDIR}/cuda/cudapartsdk CACHE PATH "" FORCE)
        ENDIF()
        ...
        IF(UNIX)
          ...
          IF(EXISTS ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.a)
            SET(OSG_CUDAPARTSDK_LIBRARY_RELEASE ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.a "" CACHE INTERNAL "" FORCE)
          ENDIF()
          IF(EXISTS ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CCB_LIBNAME}.a)
            SET(OSG_CUDAPARTSDK_LIBRARY_DEBUG ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/debug/${_OSG_CCB_LIBNAME}.a "" CACHE INTERNAL "" FORCE)
          ENDIF()
        ...
        ELSEIF(WIN32)
          ...
          IF(EXISTS ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.lib)
              SET(OSG_CUDAPARTSDK_LIBRARY_RELEASE ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}.lib "" CACHE INTERNAL "" FORCE)
          ENDIF()
          IF(EXISTS ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}D.lib)
              SET(OSG_CUDAPARTSDK_LIBRARY_DEBUG ${_SUPPORT_DIR}/lib${OSG_LIBDIR_BASE_SUFFIX}/${_OSG_CCB_LIBNAME}D.lib "" CACHE INTERNAL "" FORCE)
          ENDIF()
