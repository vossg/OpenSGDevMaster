 ...
 IF(NOT WIN32)
  ...
  FOREACH(_OSG_CFG_TYPE ${CMAKE_CONFIGURATION_TYPES})
    ...
    IF(CMAKE_CXX_FLAGS_${_OSG_CFG_TYPE})
      ...
      STRING(REPLACE ",-Werror" "" _CUDA_NVCC_XC_FLAGS ${_CUDA_NVCC_XC_FLAGS})
  ...
  MESSAGE("  Using CUDA_NVCC_FLAGS : ${CUDA_NVCC_FLAGS}")
 
  FOREACH(_OSG_CFG_TYPE ${CMAKE_CONFIGURATION_TYPES})
    STRING(TOUPPER ${_OSG_CFG_TYPE} _OSG_CFG_TYPE)
    MESSAGE("  Using CUDA_NVCC_FLAGS_${_OSG_CFG_TYPE} : ${CUDA_NVCC_FLAGS_${_OSG_CFG_TYPE}}")
  ENDFOREACH()
