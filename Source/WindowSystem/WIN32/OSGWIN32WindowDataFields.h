...
OSG_FIELD_DLLEXPORT_DECL1(SField, HWND,        OSG_WINDOWWIN32_DLLTMPLMAPPING)
OSG_FIELD_DLLEXPORT_DECL1(SField, HDC,         OSG_WINDOWWIN32_DLLTMPLMAPPING)
OSG_FIELD_DLLEXPORT_DECL1(SField, HGLRC,       OSG_WINDOWWIN32_DLLTMPLMAPPING)
OSG_FIELD_DLLEXPORT_DECL1(SField, PAINTSTRUCT, OSG_WINDOWWIN32_DLLTMPLMAPPING)

OSG_FIELD_DLLEXPORT_DECL1(MField, HWND,        OSG_WINDOWWIN32_DLLTMPLMAPPING)
OSG_FIELD_DLLEXPORT_DECL1(MField, HDC,         OSG_WINDOWWIN32_DLLTMPLMAPPING)
OSG_FIELD_DLLEXPORT_DECL1(MField, HGLRC,       OSG_WINDOWWIN32_DLLTMPLMAPPING)
OSG_FIELD_DLLEXPORT_DECL1(MField, PAINTSTRUCT, OSG_WINDOWWIN32_DLLTMPLMAPPING)

#endif

OSG_END_NAMESPACE

#define OSGWINDOWWIN32DATAFIELDS_HEADER_CVSID "@(#)$Id: $"
