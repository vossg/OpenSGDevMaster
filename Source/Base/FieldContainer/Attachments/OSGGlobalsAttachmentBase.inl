...
inline
OSG::FieldContainerType &GlobalsAttachmentBase::getClassType(void)
{
    return _type;
}
...
inline
OSG::UInt32 GlobalsAttachmentBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 GlobalsAttachmentBase::getClassGroupId(void)
{
...
inline
void GlobalsAttachmentBase::execSync (      GlobalsAttachmentBase *pFrom,
...
inline
const Char8 *GlobalsAttachmentBase::getClassname(void)
{
    return "GlobalsAttachment";
}
