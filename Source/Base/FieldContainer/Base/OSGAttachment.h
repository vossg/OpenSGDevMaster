...
class OSG_BASE_DLLMAPPING Attachment : public AttachmentBase
{
  ...
  public:
    ...
    typedef AttachmentBase Inherited;
    ...
    FieldContainer                  *getParents  (const UInt32 index) const;
  ...
  protected:
    ...
    // Variables should all be in AttachmentBase.
