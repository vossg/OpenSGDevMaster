...
OSG_FIELDTRAITS_GETTYPE   (Vec1u          )
OSG_FIELDTRAITS_GETTYPE   (Vec1i          )
...
OSG_FIELDTRAITS_GETTYPE   (Vec2u          )
OSG_FIELDTRAITS_GETTYPE   (Vec2i          )
...
OSG_FIELDTRAITS_GETTYPE   (Vec3u          )
OSG_FIELDTRAITS_GETTYPE   (Vec3i          )
...
OSG_FIELDTRAITS_GETTYPE   (Vec4u          )
OSG_FIELDTRAITS_GETTYPE   (Vec4i          )
...
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec1u         )
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec1i          )
...
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec2u          )
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec2i          )
...
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec3u          )
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec3i          )
...
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec4u          )
OSG_FIELD_DLLEXPORT_DEF1(SField, Vec4i          )
...
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec1u         )
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec1i          )
...
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec2u          )
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec2i          )
...
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec3u          )
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec3i          )
...
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec4u          )
OSG_FIELD_DLLEXPORT_DEF1(MField, Vec4i          )
