...
typedef SFieldAdaptor<GeoReferenceAttachmentPtr, SFFieldContainerPtr> SFGeoReferenceAttachmentPtr;
#endif
...
typedef MFieldAdaptor<GeoReferenceAttachmentPtr, MFFieldContainerPtr> MFGeoReferenceAttachmentPtr;
#endif
