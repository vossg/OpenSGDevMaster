...
// OSGIntersectProxyAttachmentBase.cpp file.
// To modify it, please change the .fcd file (OSGIntersectProxyAttachment.fcd) and
...
void IntersectProxyAttachment::initMethod(InitPhase ePhase)
{
...
IntersectProxyAttachment::IntersectProxyAttachment(void) :
    Inherited()
{
}
