...
#ifndef _OSGREFCOUNTMIXIN_H_
#define _OSGREFCOUNTMIXIN_H_
#ifdef __sgi
#pragma once
#endif
...
class RefCountMixin : public ParentT
{
    /*==========================  PUBLIC  =================================*/
  ...
  protected:
    ...
    RefCountMixin(void);
    RefCountMixin(const RefCountMixin &source);
  ...
  private:
    ...
    template <class Object, class Ptr>
    friend struct PtrWrapper;

    /*!\brief prohibit default function (move to 'public' if needed) */
    void operator =(const RefCountMixin &source);
};
