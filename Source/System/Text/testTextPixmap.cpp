...
void updateScene(void)
{
    ...
    Vec2f offset;
    ImageUnrecPtr imagePtr = face->makeImage(layoutResult, offset);
    ...
    GeometryUnrecPtr geo = makePlaneGeo(width * scale, height * scale, 1, 1);
    ...
    TextureTransformChunkUnrecPtr texTransChunk = TextureTransformChunk::create();
