...
namespace
{
    static OSG::Char8 cvsid_cpp[] = "@(#)$Id: OSGTextTXFGlyph.cpp,v 1.1.4.2 2006/05/08 06:01:15 vossg Exp $";
    static OSG::Char8 cvsid_hpp[] = OSGTEXTTXFGLYPH_HEADER_CVSID;
    static OSG::Char8 cvsid_inl[] = OSGTEXTTXFGLYPH_INLINE_CVSID;
}
