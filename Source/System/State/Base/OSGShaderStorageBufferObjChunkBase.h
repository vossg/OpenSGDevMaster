...
#ifndef _OSGSHADERSTORAGEBUFFEROBJCHUNKBASE_H_
#define _OSGSHADERSTORAGEBUFFEROBJCHUNKBASE_H_
#ifdef __sgi
#pragma once
#endif
...
#include "OSGShaderStorageBufferObjChunkFields.h"
...
//! \brief ShaderStorageBufferObjChunk Base Class.

class OSG_SYSTEM_DLLMAPPING ShaderStorageBufferObjChunkBase : public ShaderStorageBufferObjBaseChunk
{
  public:
    ...
    OSG_GEN_INTERNALPTR(ShaderStorageBufferObjChunk);
  ...
  public:
    ...
    static  ShaderStorageBufferObjChunkTransitPtr  create          (void);
    static  ShaderStorageBufferObjChunk           *createEmpty     (void);

    static  ShaderStorageBufferObjChunkTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderStorageBufferObjChunk            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderStorageBufferObjChunkTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    ShaderStorageBufferObjChunkBase(void);
    ShaderStorageBufferObjChunkBase(const ShaderStorageBufferObjChunkBase &source);
    ...
    virtual ~ShaderStorageBufferObjChunkBase(void);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      ShaderStorageBufferObjChunkBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const ShaderStorageBufferObjChunkBase &source);
};

typedef ShaderStorageBufferObjChunkBase *ShaderStorageBufferObjChunkBaseP;

OSG_END_NAMESPACE

#endif /* _OSGSHADERSTORAGEBUFFEROBJCHUNKBASE_H_ */
