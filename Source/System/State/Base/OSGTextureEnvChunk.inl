...
inline
const StateChunkClass *TextureEnvChunk::getStaticClass(void)
{
    return &TextureEnvChunk::_class;
}

inline
UInt32 TextureEnvChunk::getStaticClassId(void)
{
...
#define OSGTEXTUREENVCHUNK_INLINE_CVSID "@(#)$Id: $"
