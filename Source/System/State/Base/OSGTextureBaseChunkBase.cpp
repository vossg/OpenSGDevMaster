...
OSG_FIELD_DLLEXPORT_DEF2(SFieldAdaptor, TextureBaseChunkPtr, SFFieldContainerPtr);
OSG_FIELD_DLLEXPORT_DEF2(MFieldAdaptor, TextureBaseChunkPtr, MFFieldContainerPtr);
