...
UInt32 UniformBufferObjStd140Chunk::_arbUniformBufferObject   = Win::invalidExtensionID;
                                             ...
                                             UInt64                   uiOptions)
{
    ...
    bool hasUBO = pWin->hasExtOrVersion(_arbUniformBufferObject, 0x0300);
    if(!hasUBO)
    {
        FWARNING(
