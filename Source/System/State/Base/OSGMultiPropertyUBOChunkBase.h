...
#ifndef _OSGMULTIPROPERTYUBOCHUNKBASE_H_
#define _OSGMULTIPROPERTYUBOCHUNKBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief MultiPropertyUBOChunk Base Class.

class OSG_SYSTEM_DLLMAPPING MultiPropertyUBOChunkBase : public UniformBufferObjStd140Chunk
{
  public:

    typedef UniformBufferObjStd140Chunk Inherited;
    typedef UniformBufferObjStd140Chunk ParentContainer;

    typedef Inherited::TypeObject TypeObject;
    typedef TypeObject::InitPhase InitPhase;

    OSG_GEN_INTERNALPTR(MultiPropertyUBOChunk);
  ...
  public:
    ...
    static  MultiPropertyUBOChunkTransitPtr  create          (void);
    static  MultiPropertyUBOChunk           *createEmpty     (void);

    static  MultiPropertyUBOChunkTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  MultiPropertyUBOChunk            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  MultiPropertyUBOChunkTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    MultiPropertyUBOChunkBase(void);
    MultiPropertyUBOChunkBase(const MultiPropertyUBOChunkBase &source);
    ...
    virtual ~MultiPropertyUBOChunkBase(void);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      MultiPropertyUBOChunkBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const MultiPropertyUBOChunkBase &source);
};

typedef MultiPropertyUBOChunkBase *MultiPropertyUBOChunkBaseP;

OSG_END_NAMESPACE

#endif /* _OSGMULTIPROPERTYUBOCHUNKBASE_H_ */
