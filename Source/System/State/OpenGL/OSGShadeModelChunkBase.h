...
class OSG_STATE_DLLMAPPING ShadeModelChunkBase : public StateChunk
{
  public:
    ...
    OSG_GEN_INTERNALPTR(ShadeModelChunk);
  ...
  public:
    ...
    static const OSG::BitVector ShadeModelFieldMask =
        (TypeTraits<BitVector>::One << ShadeModelFieldId);
    static const OSG::BitVector NextFieldMask =
        (TypeTraits<BitVector>::One << NextFieldId);
        
    typedef SFGLenum          SFShadeModelType;
    ...
    static  ShadeModelChunkTransitPtr  create          (void);
    static  ShadeModelChunk           *createEmpty     (void);

    static  ShadeModelChunkTransitPtr  createLocal     (
  ...
  protected:
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      ShadeModelChunkBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
