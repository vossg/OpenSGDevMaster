...
struct FieldTraits<CubeTextureObjChunkPtr> : 
    public FieldTraitsTemplateBase<CubeTextureObjChunkPtr>
{
  private:
...
#define OSGCUBETEXTUREOBJCHUNKFIELDS_HEADER_CVSID "@(#)$Id: FCFieldsTemplate_h.h 106 2006-09-14 03:15:53Z dirk $"
