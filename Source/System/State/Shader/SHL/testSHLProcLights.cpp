...
static void light0Active(DrawEnv *pEnv, Int32 &iLoc)
{
    if(iLoc != -1)
    {
...
static void light1Active(DrawEnv *pEnv, Int32 &iLoc)
{
    if(iLoc != -1)
    {
        OSGGETGLFUNC(OSGglUniform1iProc,
...
static void light2Active(DrawEnv *pEnv, Int32 &iLoc)
{
    if(iLoc != -1)
    {
        OSGGETGLFUNC(OSGglUniform1iProc,
...
int doMain(int argc, char **argv)
{
    ...
    shl->addProceduralVariable("Light0Active", &light0Active);
    shl->addProceduralVariable("Light1Active", &light1Active);
    shl->addProceduralVariable("Light2Active", &light2Active);
