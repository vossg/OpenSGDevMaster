...
ShaderVariableBoolBase::TypeObject ShaderVariableBoolBase::_type(
    ...
    ShaderVariableBool::initMethod,
    ShaderVariableBool::exitMethod,
    reinterpret_cast<InitalInsertDescFunc>(&ShaderVariableBoolBase::classDescInserter),
    false,
    0,
    "<?xml version=\"1.0\"?>\n"
    "\n"
...
UInt32 ShaderVariableBoolBase::getBinSize(ConstFieldMaskArg whichField)
{
...
DataType FieldTraits<ShaderVariableBool *>::_type("ShaderVariableBoolPtr", "ShaderValueVariablePtr");
#endif

OSG_FIELDTRAITS_GETTYPE(ShaderVariableBool *)
