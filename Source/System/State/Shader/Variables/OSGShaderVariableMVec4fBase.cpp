...
ShaderVariableMVec4fBase::TypeObject ShaderVariableMVec4fBase::_type(
    ...
    reinterpret_cast<InitalInsertDescFunc>(&ShaderVariableMVec4fBase::classDescInserter),
    false,
    0,
    "<?xml version=\"1.0\"?>\n"
    "\n"
...
DataType FieldTraits<ShaderVariableMVec4f *>::_type("ShaderVariableMVec4fPtr", "ShaderValueVariablePtr");
#endif

OSG_FIELDTRAITS_GETTYPE(ShaderVariableMVec4f *)
