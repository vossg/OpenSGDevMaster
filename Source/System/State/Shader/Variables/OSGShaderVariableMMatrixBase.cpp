...
DataType FieldTraits<ShaderVariableMMatrix *>::_type("ShaderVariableMMatrixPtr", "ShaderValueVariablePtr");
#endif

OSG_FIELDTRAITS_GETTYPE(ShaderVariableMMatrix *)
...
UInt32 ShaderVariableMMatrixBase::getBinSize(ConstFieldMaskArg whichField)
{
