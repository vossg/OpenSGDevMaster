...
ShaderVariableRealBase::TypeObject ShaderVariableRealBase::_type(
    ...
    ShaderVariableReal::initMethod,
    ShaderVariableReal::exitMethod,
    reinterpret_cast<InitalInsertDescFunc>(&ShaderVariableRealBase::classDescInserter),
    false,
    0,
    "<?xml version=\"1.0\"?>\n"
    "\n"
...
UInt32 ShaderVariableRealBase::getBinSize(ConstFieldMaskArg whichField)
{
...
DataType FieldTraits<ShaderVariableReal *>::_type("ShaderVariableRealPtr", "ShaderValueVariablePtr");
#endif

OSG_FIELDTRAITS_GETTYPE(ShaderVariableReal *)
