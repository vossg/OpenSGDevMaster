...
DataType FieldTraits<ShaderVariableInt *>::_type("ShaderVariableIntPtr", "ShaderValueVariablePtr");
#endif

OSG_FIELDTRAITS_GETTYPE(ShaderVariableInt *)
...
UInt32 ShaderVariableIntBase::getBinSize(ConstFieldMaskArg whichField)
{
