...
int doMain(int argc, char **argv)
{
    ...
    shl_gp->setProgramParameter(GL_GEOMETRY_INPUT_TYPE_EXT, 
                                GL_TRIANGLES);
    shl_gp->setProgramParameter(GL_GEOMETRY_OUTPUT_TYPE_EXT, 
                                GL_TRIANGLE_STRIP);
    shl_gp->setProgramParameter(GL_GEOMETRY_VERTICES_OUT_EXT, 6);

    shl->addShader(shl_gp);
