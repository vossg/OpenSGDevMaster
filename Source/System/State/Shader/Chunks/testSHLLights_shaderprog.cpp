...
int doMain(int argc, char **argv)
{
    ...
    shl_vp->addUniformVariable("OSGLight0Active", 0);
    shl_vp->addUniformVariable("OSGLight1Active", 0);
    shl_vp->addUniformVariable("OSGLight2Active", 0);
    shl_vp->addUniformVariable("OSGViewMatrix",   0);
