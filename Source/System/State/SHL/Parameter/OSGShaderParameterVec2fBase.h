...
class OSG_STATE_DLLMAPPING ShaderParameterVec2fBase : public ShaderParameter
{
  ...
  public:
    ...
    static  ShaderParameterVec2f           *createEmpty     (void);

    static  ShaderParameterVec2fTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterVec2f            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterVec2fTransitPtr  createDependent  (BitVector bFlags);
