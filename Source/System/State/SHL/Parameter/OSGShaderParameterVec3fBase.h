...
class OSG_STATE_DLLMAPPING ShaderParameterVec3fBase : public ShaderParameter
{
  public:
    ...
    OSG_GEN_INTERNALPTR(ShaderParameterVec3f);
  ...
  public:
    ...
    static  ShaderParameterVec3fTransitPtr  create          (void);
    static  ShaderParameterVec3f           *createEmpty     (void);

    static  ShaderParameterVec3fTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterVec3f            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterVec3fTransitPtr  createDependent  (BitVector bFlags);
