...
class OSG_STATE_DLLMAPPING ShaderParameterMatrixBase : public ShaderParameter
{
  public:
    ...
    OSG_GEN_INTERNALPTR(ShaderParameterMatrix);
  ...
  public:
    ...
    static  ShaderParameterMatrixTransitPtr  create          (void);
    static  ShaderParameterMatrix           *createEmpty     (void);

    static  ShaderParameterMatrixTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterMatrix            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterMatrixTransitPtr  createDependent  (BitVector bFlags);
