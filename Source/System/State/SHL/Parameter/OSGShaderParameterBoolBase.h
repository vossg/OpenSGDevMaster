...
class OSG_STATE_DLLMAPPING ShaderParameterBoolBase : public ShaderParameter
{
  public:
    ...
    OSG_GEN_INTERNALPTR(ShaderParameterBool);
  ...
  public:
    ...
    static  ShaderParameterBoolTransitPtr  create          (void);
    static  ShaderParameterBool           *createEmpty     (void);

    static  ShaderParameterBoolTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterBool            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterBoolTransitPtr  createDependent  (BitVector bFlags);
