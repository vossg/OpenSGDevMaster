...
class OSG_STATE_DLLMAPPING ShaderParameterMVec2fBase : public ShaderParameter
{
  ...
  public:
    ...
    static  ShaderParameterMVec2f           *createEmpty     (void);

    static  ShaderParameterMVec2fTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterMVec2f            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterMVec2fTransitPtr  createDependent  (BitVector bFlags);
