...
typedef FieldContainerPtrSField<ShaderParameterIntPtr> SFShaderParameterIntPtr;
#endif
...
typedef FieldContainerPtrMField<ShaderParameterIntPtr> MFShaderParameterIntPtr;
#endif
