...
class OSG_STATE_DLLMAPPING ShaderParameterMVec3fBase : public ShaderParameter
{
  ...
  public:
    ...
    static  ShaderParameterMVec3f           *createEmpty     (void);

    static  ShaderParameterMVec3fTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterMVec3f            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterMVec3fTransitPtr  createDependent  (BitVector bFlags);
