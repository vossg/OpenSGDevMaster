...
class OSG_STATE_DLLMAPPING ShaderParameterMVec4fBase : public ShaderParameter
{
  ...
  public:
    ...
    static  ShaderParameterMVec4f           *createEmpty     (void);

    static  ShaderParameterMVec4fTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterMVec4f            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterMVec4fTransitPtr  createDependent  (BitVector bFlags);
