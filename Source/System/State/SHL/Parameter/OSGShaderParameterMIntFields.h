...
struct FieldTraits<ShaderParameterMIntPtr> :
    public FieldTraitsTemplateBase<ShaderParameterMIntPtr>
{
  private:
...
typedef SFieldAdaptor<ShaderParameterMIntPtr, SFFieldContainerPtr> SFShaderParameterMIntPtr;
#endif

#ifndef OSG_COMPILESHADERPARAMETERMINTINST
OSG_FIELD_DLLEXPORT_DECL1(SField, ShaderParameterMIntPtr, OSG_STATE_DLLTMPLMAPPING)
#endif

#if !defined(OSG_DO_DOC) || defined(OSG_DOC_FIELD_TYPEDEFS)
/*! \ingroup GrpStateFieldMulti */

typedef MFieldAdaptor<ShaderParameterMIntPtr, MFFieldContainerPtr> MFShaderParameterMIntPtr;
#endif

#ifndef OSG_COMPILESHADERPARAMETERMINTINST
OSG_FIELD_DLLEXPORT_DECL1(MField, ShaderParameterMIntPtr, OSG_STATE_DLLTMPLMAPPING)
#endif
