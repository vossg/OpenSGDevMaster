...
#if 0
void ShaderParameterMMatrixBase::execBeginEditV(ConstFieldMaskArg whichField,
                                       UInt32            uiAspect,
...
OSG_FIELD_DLLEXPORT_DEF2(SFieldAdaptor, ShaderParameterMMatrixPtr, SFFieldContainerPtr);
OSG_FIELD_DLLEXPORT_DEF2(MFieldAdaptor, ShaderParameterMMatrixPtr, MFFieldContainerPtr);
