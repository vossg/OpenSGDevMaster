...
class OSG_STATE_DLLMAPPING ShaderParameterRealBase : public ShaderParameter
{
  public:
    ...
    OSG_GEN_INTERNALPTR(ShaderParameterReal);
  ...
  public:
    ...
    static  ShaderParameterReal           *createEmpty     (void);

    static  ShaderParameterRealTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterReal            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterRealTransitPtr  createDependent  (BitVector bFlags);
