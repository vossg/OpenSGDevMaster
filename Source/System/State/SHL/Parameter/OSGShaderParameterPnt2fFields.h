...
typedef SFieldAdaptor<ShaderParameterPnt2fPtr, SFFieldContainerPtr> SFShaderParameterPnt2fPtr;
#endif
...
typedef MFieldAdaptor<ShaderParameterPnt2fPtr, MFFieldContainerPtr> MFShaderParameterPnt2fPtr;
#endif
