...
class OSG_STATE_DLLMAPPING ShaderParameterMRealBase : public ShaderParameter
{
  ...
  public:
    ...
    static  ShaderParameterMReal           *createEmpty     (void);

    static  ShaderParameterMRealTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  ShaderParameterMReal            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  ShaderParameterMRealTransitPtr  createDependent  (BitVector bFlags);
