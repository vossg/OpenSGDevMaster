...
void ShaderParameterStringBase::classDescInserter(TypeObject &oType)
{
    ...
    pDesc = new SFString::Description(
        ...
        static_cast<FieldEditMethodSig>(&ShaderParameterStringBase::editHandleValue),
        static_cast<FieldGetMethodSig >(&ShaderParameterStringBase::getHandleValue));
...
OSG_SFIELDTYPE_INST(FieldContainerPtrSField, ShaderParameterStringPtr, 0);

OSG_FIELD_DLLEXPORT_DEF2(FieldContainerPtrSField, ShaderParameterStringPtr, 0);

OSG_MFIELDTYPE_INST(FieldContainerPtrMField, ShaderParameterStringPtr, 0);

OSG_FIELD_DLLEXPORT_DEF2(FieldContainerPtrMField, ShaderParameterStringPtr, 0);
