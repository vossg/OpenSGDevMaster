...
OSG_FIELD_DLLEXPORT_DEF2(SFieldAdaptor, ShaderParameterPnt3fPtr, SFFieldContainerPtr);
OSG_FIELD_DLLEXPORT_DEF2(MFieldAdaptor, ShaderParameterPnt3fPtr, MFFieldContainerPtr);
