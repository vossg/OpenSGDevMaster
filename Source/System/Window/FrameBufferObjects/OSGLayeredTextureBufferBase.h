...
#ifndef _OSGLAYEREDTEXTUREBUFFERBASE_H_
#define _OSGLAYEREDTEXTUREBUFFERBASE_H_
#ifdef __sgi
#pragma once
#endif
...
#include "OSGLayeredTextureBufferFields.h"
...
//! \brief LayeredTextureBuffer Base Class.

class OSG_SYSTEM_DLLMAPPING LayeredTextureBufferBase : public FrameBufferAttachment
{
  public:
    ...
    OSG_GEN_INTERNALPTR(LayeredTextureBuffer);
  ...
  public:
    ...
    static  LayeredTextureBufferTransitPtr  create          (void);
    static  LayeredTextureBuffer           *createEmpty     (void);

    static  LayeredTextureBufferTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  LayeredTextureBuffer            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  LayeredTextureBufferTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    LayeredTextureBufferBase(void);
    LayeredTextureBufferBase(const LayeredTextureBufferBase &source);
    ...
    virtual ~LayeredTextureBufferBase(void);
    ...
    void onCreate(const LayeredTextureBuffer *source = NULL);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      LayeredTextureBufferBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const LayeredTextureBufferBase &source);
};

typedef LayeredTextureBufferBase *LayeredTextureBufferBaseP;

OSG_END_NAMESPACE

#endif /* _OSGLAYEREDTEXTUREBUFFERBASE_H_ */
