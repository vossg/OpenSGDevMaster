...
OSG_FIELD_DLLEXPORT_DECL1(MField, GradientBackgroundPtr, OSG_WINDOW_DLLTMPLMAPPING)
#endif

OSG_END_NAMESPACE

#define OSGGRADIENTBACKGROUNDFIELDS_HEADER_CVSID "@(#)$Id: OSGGradientBackgroundFields.h,v 1.1.2.4 2006/08/01 08:49:00 vossg Exp $"
