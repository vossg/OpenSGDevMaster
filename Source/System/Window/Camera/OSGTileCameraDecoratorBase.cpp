...
OSG_SFIELDTYPE_INST(FieldContainerPtrSField, TileCameraDecoratorPtr, 0);

OSG_FIELD_DLLEXPORT_DEF2(FieldContainerPtrSField, TileCameraDecoratorPtr, 0);

OSG_MFIELDTYPE_INST(FieldContainerPtrMField, TileCameraDecoratorPtr, 0);

OSG_FIELD_DLLEXPORT_DEF2(FieldContainerPtrMField, TileCameraDecoratorPtr, 0);
