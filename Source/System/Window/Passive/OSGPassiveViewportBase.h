...
class OSG_WINDOW_DLLMAPPING PassiveViewportBase : public Viewport
{
  public:
  ...
  public:
    ...
    static  PassiveViewport           *createEmpty     (void);

    static  PassiveViewportTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  PassiveViewport            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  PassiveViewportTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      PassiveViewportBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
