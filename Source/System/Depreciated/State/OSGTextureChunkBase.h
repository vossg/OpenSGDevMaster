...
class OSG_SYSTEM_DLLMAPPING TextureChunkBase : public TextureBaseChunk
{
  ...
  protected:
    ...
    SFColor4f::GetHandlePtr  getHandleEnvColor        (void);
    SFColor4f::EditHandlePtr editHandleEnvColor       (void);
    ...
    SFVec3f::GetHandlePtr  getHandleShaderConstEye  (void);
    SFVec3f::EditHandlePtr editHandleShaderConstEye (void);
...
/** Type specific RefPtr type for TextureChunk. */
typedef RefPtr<TextureChunkPtr> TextureChunkRefPtr;

typedef boost::mpl::if_<
    boost::mpl::bool_<TextureChunkBase::isNodeCore>,
