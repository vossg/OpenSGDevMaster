...
class OSG_GROUP_DLLMAPPING ScreenLODBase : public Group
{
  ...
  public:
    ...
    /*! \{                                                                 */
            ...
            MFReal32           ::reference       editCoverageOverride(const UInt32 index);
                  Real32               getCoverageOverride (const UInt32 index) const;
    ...
    static  ScreenLODTransitPtr  createDependent  (BitVector bFlags);
