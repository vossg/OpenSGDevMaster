...
#ifndef _OSGHDRSTAGEDATA_H_
#define _OSGHDRSTAGEDATA_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_EFFECTGROUPS_DLLMAPPING HDRStageData : public HDRStageDataBase
{
  ...
  protected:
    ...
    // Variables should all be in HDRStageDataBase.
    ...
    HDRStageData(void);
    HDRStageData(const HDRStageData &source);
  ...
  private:
    ...
    void operator =(const HDRStageData &source);
};

OSG_END_NAMESPACE

#include "OSGHDRStageDataBase.inl"
#include "OSGHDRStageData.inl"

#endif /* _OSGHDRSTAGEDATA_H_ */
