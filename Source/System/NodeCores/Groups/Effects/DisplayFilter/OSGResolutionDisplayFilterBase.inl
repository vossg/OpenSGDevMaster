...
inline
OSG::UInt16 ResolutionDisplayFilterBase::getClassGroupId(void)
{
...
//! Get the value of the ResolutionDisplayFilter::_sfDownScale field.
inline
      Real32  ResolutionDisplayFilterBase::getDownScale(void) const
{
    return _sfDownScale.getValue();
}
...
inline
void ResolutionDisplayFilterBase::execSync (      ResolutionDisplayFilterBase *pFrom,
                                  ...
                                  const UInt32             uiSyncInfo)
{
    ...
    if(FieldBits::NoField != (DownScaleFieldMask & whichField))
        _sfDownScale.syncWith(pFrom->_sfDownScale);
}
#endif


inline
const Char8 *ResolutionDisplayFilterBase::getClassname(void)
{
    return "ResolutionDisplayFilter";
}
