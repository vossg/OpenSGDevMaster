...
static const OSG::UInt32 uiMainRenderMask = 0x0001;
static const OSG::UInt32 uiCubeRenderMask = 0x0002;
...
OSG::NodeTransitPtr setupAnim(void)
{
    ...
    returnValue->setTravMask(uiCubeRenderMask);
...
//    pCubeRoot->setCore(Group::create());
    ...
    pCubeVisit->setSubTreeTravMask(uiCubeRenderMask                  );
    pCubeVisit->setTravMaskMode   (OSG::VisitSubTree::ReplaceTravMask);
...
//        vp->setRoot( root );
    ...
    vp->setTravMask(uiMainRenderMask);
