...
static int grow_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)   /* e and h can be the same. */
//int elen;
//REAL *e;
//REAL b;
//REAL *h;
...
static int fast_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)           /* h cannot be e or f. */
//int elen;
//REAL *e;
//int flen;
//REAL *f;
...
static int fast_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)  /* h cannot be e or f. */
//int elen;
//REAL *e;
//int flen;
//REAL *f;
...
static int linear_expansion_sum(int elen, REAL *e, int flen, REAL *f, REAL *h)         /* h cannot be e or f. */
//int elen;
//REAL *e;
//int flen;
//REAL *f;
...
static int linear_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h) /* h cannot be e or f. */
//int elen;
//REAL *e;
//int flen;
//REAL *f;
...
static int scale_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)   /* e and h cannot be the same. */
//int elen;
//REAL *e;
//REAL b;
//REAL *h;
