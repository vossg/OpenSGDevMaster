...
#ifndef OSGGEOTEXCOORDSFIELDS_H
#define OSGGEOTEXCOORDSFIELDS_H
...
typedef MFUnrecGeoVectorPropertyPtr MFGeoTexCoordsPtr;
typedef MFUnrecGeoVectorPropertyPtr MFUnrecGeoTexCoordsPtr;
