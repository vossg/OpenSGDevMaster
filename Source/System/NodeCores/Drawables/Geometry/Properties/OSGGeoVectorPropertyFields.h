...
typedef FieldContainerPtrSField<GeoVectorPropertyPtr> SFGeoVectorPropertyPtr;
#endif
...
typedef FieldContainerPtrMField<GeoVectorPropertyPtr> MFGeoVectorPropertyPtr;
#endif
