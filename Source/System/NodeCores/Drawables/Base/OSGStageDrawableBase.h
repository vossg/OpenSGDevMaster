...
#ifndef _OSGSTAGEDRAWABLEBASE_H_
#define _OSGSTAGEDRAWABLEBASE_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_SYSTEM_DLLMAPPING StageDrawableBase : public Drawable
{
  public:
    ...
    OSG_GEN_INTERNALPTR(StageDrawable);
  ...
  protected:
    ...
    StageDrawableBase(void);
    StageDrawableBase(const StageDrawableBase &source);
    ...
    virtual ~StageDrawableBase(void);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      StageDrawableBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
...
#endif /* _OSGSTAGEDRAWABLEBASE_H_ */
