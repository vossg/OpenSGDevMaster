...
#ifndef _OSGANIMCHANNELBASE_H_
#define _OSGANIMCHANNELBASE_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_DYNAMICS_DLLMAPPING AnimChannelBase : public NodeCore
{
  public:
    ...
    OSG_GEN_INTERNALPTR(AnimChannel);
  ...
  protected:
    ...
    AnimChannelBase(void);
    AnimChannelBase(const AnimChannelBase &source);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      AnimChannelBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const AnimChannelBase &source);
};
