...
/*! \var ShaderProgramChunk * HardwareSkinningAlgorithmBase::_sfShaderCode
...
void HardwareSkinningAlgorithmBase::classDescInserter(TypeObject &oType)
{
    ...
    pDesc = new SFUnrecShaderProgramChunkPtr::Description(
        ...
        static_cast<FieldEditMethodSig>(&HardwareSkinningAlgorithm::editHandleShaderCode),
        static_cast<FieldGetMethodSig >(&HardwareSkinningAlgorithm::getHandleShaderCode));
...
//! Get the HardwareSkinningAlgorithm::_sfShaderCode field.
const SFUnrecShaderProgramChunkPtr *HardwareSkinningAlgorithmBase::getSFShaderCode(void) const
{
    return &_sfShaderCode;
}

SFUnrecShaderProgramChunkPtr *HardwareSkinningAlgorithmBase::editSFShaderCode     (void)
{
...
GetFieldHandlePtr HardwareSkinningAlgorithmBase::getHandleShaderCode      (void) const
{
...
EditFieldHandlePtr HardwareSkinningAlgorithmBase::editHandleShaderCode     (void)
{
    ...
    returnValue->setSetMethod(
        boost::bind(&HardwareSkinningAlgorithm::setShaderCode,
...
void HardwareSkinningAlgorithmBase::resolveLinks(void)
{
    ...
    static_cast<HardwareSkinningAlgorithm *>(this)->setShaderCode(NULL);
