...
class OSG_DRAWABLE_DLLMAPPING FresnelMaterial : public FresnelMaterialBase
{
  private:
  ...
  private:
    ...
    TextureObjChunkUnrecPtr     _textureObjChunk;
    TextureEnvChunkUnrecPtr     _textureEnvChunk;
