...
inline
OSG::FieldContainerType &VariantMaterialBase::getClassType(void)
{
    return _type;
}
...
inline
OSG::UInt32 VariantMaterialBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 VariantMaterialBase::getClassGroupId(void)
{
...
inline
void VariantMaterialBase::execSync (      VariantMaterialBase *pFrom,
                                  ...
                                  const UInt32             uiSyncInfo)
{
    ...
    if(FieldBits::NoField != (FallbackMaterialFieldMask & whichField))
        _sfFallbackMaterial.syncWith(pFrom->_sfFallbackMaterial);
}
#endif


inline
const Char8 *VariantMaterialBase::getClassname(void)
{
